    ...
    def validate_batch(self):
        ...
        if errors or warnings:
            return {
                ...
                'view_mode': 'form',
                 'res_model': 'batch.error.wizard',
                'target': 'new',
                 'res_id': self.env['batch.error.wizard'].create_from_errors_list(self, errors, warnings).id,
            }
...
# 
    ...
    def print_batch_payment(self):
        return self.env.ref('batch_payment.action_print_batch_payment').report_action(self, config=False)
