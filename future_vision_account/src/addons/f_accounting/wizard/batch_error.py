...
class BatchErrorWizard(models.TransientModel):
    ...
    batch_payment_id = fields.Many2one(comodel_name='batch.payment', required=True, help="The batch payment generating the errors and warnings displayed in this wizard.")
